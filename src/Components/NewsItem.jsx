const NewsItem =(props)=> {
        ...
        return (
            <div className="my-3">
                <div className="card" >
                    <img src={!imageUrl?"https://s.france24.com/media/display/d1676b6c-0770-11e9-8595-005056a964fe/w:1280/p:16x9/news_1920x1080.png":imageUrl} className="card-img-top embed-responsive--16by9" style={{maxHeight:""}} alt="imaged"/>
